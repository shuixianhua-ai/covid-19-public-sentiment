...
if (typeof Chart !== "undefined") {
  ...
  // Line with line
  const lineWithLinePlugin1 = {
    afterInit: function (chart, options) {
      const info = chart.canvas.parentNode;
      const label = 'economy';  //这里改
      info.querySelector(".chart-value").innerHTML = "经济";
      info.querySelector(".chart-label").innerHTML = 'data by month';
    },
  };

  const lineWithLinePlugin2 = {
    afterInit: function (chart, options) {
      const info = chart.canvas.parentNode;
      const label = 'Medical';  //这里改
      info.querySelector(".chart-value").innerHTML = "医疗";
      info.querySelector(".chart-label").innerHTML = 'data by month';
    },
  };

  const lineWithLinePlugin3 = {
    afterInit: function (chart, options) {
      const info = chart.canvas.parentNode;
      const label = 'Public';  //这里改
      info.querySelector(".chart-value").innerHTML = "民众";
      info.querySelector(".chart-label").innerHTML = 'data by month';
    },
  };

  const lineWithLinePlugin4 = {
    afterInit: function (chart, options) {
      const info = chart.canvas.parentNode;
      const label = 'Internation';  //这里改
      info.querySelector(".chart-value").innerHTML = "国际";
      info.querySelector(".chart-label").innerHTML = 'data by month';
    },
  };

  const lineWithLineOptions1 = {
    layout: {
      padding: {
        left: 5,
        right: 5,
        ...
        datasets: [
          {
            ...
            pointHoverRadius: 2,
            fill: false,
            data: [100, 300, 1000, 1000],
          },
        ],
      },
      options: lineWithLineOptions1,
    });
  }
        ...
        datasets: [
          {
            ...
            pointHoverRadius: 2,
            fill: false,
            data: [700, 600, 700, 350],
          },
        ],
      },
      options: lineWithLineOptions2,
    });
  }
        ...
        datasets: [
          {
            ...
            pointHoverRadius: 2,
            fill: false,
            data: [300,400,600,400],
          },
        ],
      },
      options: lineWithLineOptions3,
    });
  }
        ...
        datasets: [
          {
            ...
            pointHoverRadius: 2,
            fill: false,
            data: [120, 150, 300, 600],
          },
        ],
      },
      options: lineWithLineOptions4,
    });
  }
        ...
        datasets: [
          {
            backgroundColor: [
              ...
              "rgba(" + colors.primary + ", .75)",
            ],
            borderColor: "rgba(" + colors.primary + ")",
            borderWidth: 2,
            data: [0.448, 0.267, 0.161, 0.124],
          },
        ],
      },
